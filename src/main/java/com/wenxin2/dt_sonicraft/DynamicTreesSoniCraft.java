package com.wenxin2.dt_sonicraft;
...
@Mod(DynamicTreesSoniCraft.MOD_ID)
public final class DynamicTreesSoniCraft {

    public static final String MOD_ID = "dt_sonicraft";

    public DynamicTreesSoniCraft() {
